...
{{< project-card title="Wedge Calculator" language="desmos" desc="A wedge calculator and visualizer in Desmos. Shows all forces for a simple wedge system" img="https://picsum.photos/300/200" srclink="https://github.com/example" >}}
...
{{< project-card title="Micromouse" language="c++" desc="Meet Pixel, an autonomous maze-solving robot! Powered by an STM32 Nucleo, it runs floodfill to solve a maze as fast as possible! Includes a 2-wheel drivetrain, gyroscopic correction, and encoder odometry." img="https://picsum.photos/300/200" srclink="https://github.com/priyam-k/ieee-micromouse" >}}
